...
\bibitem{furps} Software Metrics: Establishing a Company-wide Program. Grady Robert, Caswell Deborah. Prentice Hall. 1987.
\bibitem{fourplusone} Architectural Blueprints—The “4+1” View Model of Software Architecture. Philippe Kruchten. IEEE Software. 1995.
\bibitem{researchreview} “可信软件基础研究”重大研究计划综述. 刘克. 中国科学基金. 2008. 
\bibitem{thebook} 《软件架构理论与实践》. 李必信, 廖力, 王璐璐~等. 机械工业出版社. 2019.
\bibitem{courseware} 《软件开发方法与技术》课程课件. 李必信. （内部资料）. 2021.
\bibitem{opensource} 开源软件可信性评价方法. 孙晶, 刘丽丽. 计算机工程与设计. 2017.
\bibitem{misc1} 基于多维质量属性偏好的可信服务选择. 吴晓娜, 李必信, 刘翠翠~等. 计算机应用与软件. 2012.
\bibitem{misc2} 基于证据的软件过程可信度模型及评估方法. 王德鑫, 王青, 贺\hbox{\scalebox{0.6}[1]{吉}\kern-.2em\scalebox{0.6}[1]{力}}. 软件学报. 2017.
\end{thebibliography}
